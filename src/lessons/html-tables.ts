...
table {
  ...
  quiz: [
    ...
    },
    {
      ...
      options_ru: ['border: none', 'border-collapse: collapse', 'border-spacing: 0', 'outline: none'],
      options_en: ['border: none', 'border-collapse: collapse', 'border-spacing: 0', 'outline: none'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options_ru: ['rowspan', 'colspan', 'span', 'merge'],
      options_en: ['rowspan', 'colspan', 'span', 'merge'],
      correctIndex: 1,
