...
it will be easier to understand what is happening "under the hood".`,
  ...
  quiz: [
    ...
    },
    {
      ...
      options_ru: ['git pull', 'git push', 'git add', 'git status'],
      options_en: ['git pull', 'git push', 'git add', 'git status'],
      correctIndex: 1,
    ...
    },
    {
      ...
      options_ru: ['Коммит (commit)', 'Репозиторий (repository)', 'Ветка (branch)', 'Клон (clone)'],
      options_en: ['Commit', 'Repository', 'Branch', 'Clone'],
      correctIndex: 2,
