...
import { Search, Menu, X, Code2, LayoutDashboard, BookMarked, User, LogOut, ShieldCheck, ClipboardList, Globe, School, FlaskConical, Map, Container } from 'lucide-react'
...
export function Navbar({ onSearchOpen, onSignInOpen }: NavbarProps) {
  ...
  const navLinks = [
    ...
    { href: '/devops', label: t('nav.devops', 'DevOps'), icon: Container },
